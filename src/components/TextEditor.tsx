      ...
      <Card className="shadow-md border-2 border-muted mb-6">
        <CardHeader>
          <CardTitle className="text-xl text-vault-primary font-semibold flex justify-between">
            ...
            <Badge variant="outline" className="bg-vault-accent/10 text-vault-accent">
              New Entry
            </Badge>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="mt-4">
              ...
              <div className="rounded-md bg-muted p-4 min-h-[100px] whitespace-pre-wrap">
                {preview || <span className="text-muted-foreground italic">Processing preview will appear here</span>}
              </div>
            </div>

            <div className="flex flex-wrap gap-2 text-xs text-muted-foreground">
              <span className="px-2 py-1 rounded bg-muted">Words: {stats.wordCount}</span>
              <span className="px-2 py-1 rounded bg-muted">Characters: {stats.charCount}</span>
              <span className="px-2 py-1 rounded bg-muted">Characters (no spaces): {stats.charCountNoSpaces}</span>
              <span className="px-2 py-1 rounded bg-muted">Lines: {stats.lineCount}</span>
            </div>
          </div>
        </CardContent>
        <CardFooter>
